    ...
    <footer className="w-full bg-[#040408] py-16 border-t border-[rgba(255,255,255,0.05)]">
      <div className="container mx-auto px-6">
        <div className="flex flex-col items-center">
          ...
          <div className="mb-10 rounded-full border border-[rgba(255,255,255,0.1)] hover:border-[#3A9BD5] transition-colors duration-500 overflow-hidden w-24 h-24 flex items-center justify-center p-0">
            <img src="/transparent-image.png" alt="LockRhythm Logo" className="w-full h-full object-contain object-center scale-[1.5]" />
          </div>
